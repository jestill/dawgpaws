...
sub ltrfinder2gff {
	...
	#Domain: 56796 - 57326 [possible ORF:56259-59144, (IN (core))]
	    ...
	    #/////////////////////////
#	    # Test to see if data are getting in
#	    print STDOUT "=====\n";
#	    print STDOUT $ltr_results[$i]->{lf_dom}[$j]->{lf_dom_start}."\n";
#	    print STDOUT $ltr_results[$i]->{lf_dom}[$j]->{lf_dom_end}."\n";
#	    print STDOUT $ltr_results[$i]->{lf_dom}[$j]->{lf_dom_name}."\n";
#	    print STDOUT "=====\n";
	    #//////////////////////////
...
#	#-----------------------------+
#	print STDOUT "{\n";
#	for my $part ( keys %$href ) {
#	    print STDOUT "   $part=$href->{$part} \n";
#
#	}
#	# End of everything for that LTR retro model
#	print STDOUT "}\n";
