...
=head1 SYNOPSIS
  ...
  ADDITIONAL OPTIONS
    --gff           # Produce a gff formatted output of the results
    --quiet         # Run the program in quiet mode
    --verbose       # Run the program with maximum output to STDERR
  
  ADDITIONAL PROGRAM INFORMATION
    --usage         # Show basic program usage
    --help          # Show program synopsis
...
directory. This allows the find_ltr.pl program location to be at 
any specific location .

B<Configuartion File>
