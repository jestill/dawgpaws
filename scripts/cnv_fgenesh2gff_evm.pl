...
#	    my @exons_ordered = $gene->exons_ordered();
	    ...
	    my $mrna_parent = $seq_id."_".$source."_".$gene_id;
	    $mrna_id = $seq_id."_".$source."_mrna_of_".$gene_id;
	    my $attribute = "ID=".$mrna_id.";Parent=".
		$mrna_parent;
...
#	    }
	    ...
	    if ($gff_ver =~ "GFF3") {
		$attribute = "ID=". $seq_id."_".$source."_".
		    $gene_id."_".$exon_id.
		    "\;Parent=".$mrna_id;
		$feature = "exon";
	    }
	    ...
	    # CDS
	    my $cds_parent =  $seq_id."_".$source."_".
		$gene_id."_".$exon_id;
	    my $cds_id = "cds_of_".
		$seq_id."_".$source."_".
		$gene_id."_".$exon_id;
	    my $attribute = "ID=".$cds_id.";Parent=".$mrna_id;
	    print GFFOUT $seq_id."\t".     # Seqname
		$source."\t".              # Source
		"CDS\t".             #feature
		$start."\t".               # start
...
This documentation refers to program version $Rev: 888 $
