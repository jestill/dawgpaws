...
# Jamie changed the following to just look for txt files
# I will not be including the fasta extension in the
# name of the fgenesh output text files.
...
#    }
	...
	if ($PrintGeneSpan)
	    ...
	    #print GFFOUT $ref->{sequence};                        # ATTRIBUTE
	    print GFFOUT "\n";
	}
